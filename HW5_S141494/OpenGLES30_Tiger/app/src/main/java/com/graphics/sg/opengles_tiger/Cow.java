...
public class Cow extends Object {
     ...
     */
    final static int N_COW_FRAMES = 12;

    float vertices[][] = new float[N_COW_FRAMES][];
    int n_triangles[] = new int[N_COW_FRAMES];
    int vertex_offset[] = new int[N_COW_FRAMES];
